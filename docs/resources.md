...
- [**ICON Subreddit**](https://www.reddit.com/r/helloicon)

- [**ICON Discord Server**](https://discord.com/invite/5rgATWa) 
...
- [**Band Protocol Oracle Integration**](https://www.icondev.io/docs/band-protocol)
- [**ICON Bridge**](https://github.com/bandprotocol/bandchain/tree/master/bridges/icon)
- [**Full DICE SCORE with bank protocol integration**](https://github.com/OpenDevICON/bandprotocol-dice)
